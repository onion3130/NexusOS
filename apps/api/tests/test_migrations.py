...
def test_schema_upgrade_downgrade_upgrade(tmp_path) -> None:
    ...
    assert {"encryption_status", "encrypted_relative_path", "encrypted_size_bytes", "encrypted_sha256", "replication_status", "replicated_at", "replication_error_code", "restored_at"}.issubset(columns)
