...
import { confirmProposal, createProposal, listActionCatalog, listAuditEvents, listBackups, listProposals, readDeploymentStatus, rejectProposal, type ActionCatalogItem, type ActionProposal, type AuditEvent, type Backup, type DeploymentStatus } from "../lib/host-actions";
